        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              <div className="bg-card rounded-xl p-8 shadow-soft border border-border h-full">
                <div className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center mb-4">
                  <FaRocket className="text-primary-foreground text-xl" />
                </div>
            ...
            >
              <div className="bg-card rounded-xl p-8 shadow-soft border border-border h-full">
                <div className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center mb-4">
                  <FaTrophy className="text-primary-foreground text-xl" />
                </div>
            ...
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-primary rounded-full text-primary-foreground text-2xl mb-4">
                    {stat.icon}
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/contact">
                <button className="bg-background text-primary hover:bg-background/90 px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:shadow-glow">
                  Get in Touch
                </button>
              </a>
              <a href="/services">
                <button className="bg-background/10 backdrop-blur-sm border border-primary-foreground/30 text-primary-foreground hover:bg-background/20 px-8 py-4 rounded-lg font-semibold transition-all duration-300">
                  View Our Services
                </button>
              </a>
            </div>
